...
![MVVM-Service](./docs/public/mvvm.png)

## Architectures
### Auth
![Auth](./docs/public/auth.png)

### Medicine
![Medicine](./docs/public/medicine.png)

### PEF
![PEF](./docs/public/pef.png)

### Check-In
![Check-In](./docs/public/check_in.png)

### Notification
![Notification](./docs/public/notification.png)

### Incident
![Incident](./docs/public/incident.png)

## Developer Docs
- [Models Reference](docs/models.md)
- [Services (Repositories)](docs/services.md)
- [ViewModels Usage](docs/viewmodels.md)
- [Screens & Layout Map](docs/pages.md)
- [Charts Usage](docs/charts.md)

## Sample Test Accounts
Running `TestAPIActivity` seeds Firebase Auth with one parent, child, and provider account using predictable email/password patterns so you can log back in immediately:

| User type | Email template | Password |
|-----------|----------------|----------|
| Parent | `{parentUid}@seed-parent.example.com` | `ParentPass123!` |
| Child | `{childUid}@seed-child.example.com` | `ChildPass123!` |
| Provider | `{providerUid}@seed-provider.example.com` | `ProviderPass123!` |

`{parentUid}`, `{childUid}`, and `{providerUid}` are random strings printed in the `TestAPIActivity` status label/logcat when the script runs (e.g., `test-parent-1234...`). Grab those values, plug them into the email templates above, and use the matching password to sign back in as each role.
