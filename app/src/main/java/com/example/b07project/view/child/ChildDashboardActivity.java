...
public class ChildDashboardActivity extends BackButtonActivity {
    ...
    /** Called when the user touches the log medicine button to go to log medicine page*/
    ...
    /** Called when the user touches the settings button in child dashboard to go to child settings*/
    ...
    /** Called when the user touches the badge button in child dashboard to view badges page*/
