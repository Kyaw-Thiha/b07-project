...
public class TestAPIActivity extends AppCompatActivity {
    ...
    private void createSampleData() {
        ...
        textStatus.setText("Creating data for parent " + parentUid + ", child " + childUid + ", provider " + providerUid + "...");
        ...
        try {
            ...
            BaseUser providerBase = new BaseUser(providerUid, "Test Provider", "provider+" + providerUid + "@example.com", providerRole);

            ParentUser parentUser = new ParentUser(parentUid, parentBase.getName(), parentBase.getEmail(), parentRole);
            ChildUser childUser = new ChildUser(childUid, childBase.getName(), childBase.getEmail(), childRole, true, parentUid);
            ProviderUser providerUser = new ProviderUser(providerUid, providerBase.getName(), providerBase.getEmail(), providerRole);
            ...
            Medicine med = new Medicine("11/20/25", "01/26/26", 0.63, 200, "stuffs", parentUid);
            ...
            Toast.makeText(this, "Created parent " + parentUid + ", child " + childUid + ", provider " + providerUid, Toast.LENGTH_LONG)
                    .show();
